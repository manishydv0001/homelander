        ...
        <div className='flex flex-col md:flex-row gap-8 md:gap-36 mx-4 md:mx-28 m-11'>
            <div className='flex-1'>
                <div className='text-lg md:text-2xl font-sans px-2 md:px-4'>
                    ...
                    <div>123 Main Street, <div /> USA 12345</div>
                    <div className='text-lg md:text-3xl py-2 md:py-4'>$49,000</div>
                </div>
                <div>
                    <img src="public/assets/img/houses/house7lg.png" alt="Loading" className='w-full md:w-auto'/>
                </div>
