        ...
        <div className='flex flex-col md:flex-row gap-8 md:gap-36 mx-4 md:mx-28  m-11'>
            <div className='flex-1'>
                <div className='text-lg md:text-2xl font-sans px-2 md:px-4'>
                    <div className='font-sans text-xl md:text-3xl'>Apartment</div>
            ...
            <div className='text-lg md:text-2xl border rounded border-[rgb(167,163,163)] w-full md:w-6/12 py-6 md:py-10 my-6 md:my-10  '>
                <div className='border rounded border-[rgb(167,163,163)] my-4 md:my-6 mx-2 md:mx-16'>
                ...
                <div className='flex flex-col md:flex-row justify-around items-center gap-4 md:gap-6  '>
                    <button className='border rounded border-[rgb(167,163,163)] my-4 md:my-6 text-lg md:text-xl py-2 md:py-3 px-4 md:px-5  text-slate-500'>Send Message</button>
                    <button className='border rounded border-[rgb(167,163,163)] text-lg md:text-xl py-2 md:py-3 px-4 md:px-5 text-slate-500 '>Call</button>
                </div>
            </div>
        </div>
    )
