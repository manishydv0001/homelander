        ...
        <div className='flex flex-col md:flex-row gap-8 md:gap-36 mx-4 md:mx-28 m-11'>
            <div className='flex-1'>
                <div className='text-lg md:text-2xl font-sans px-2 md:px-4'>
                    ...
                    <div>45 Tenth Avenue, <div /> NY 100114</div>
                    <div className='text-xl md:text-3xl py-2 md:py-4'>$42,000</div>
                </div>
                <div>
                    <img src="public/assets/img/houses/house2lg.png" alt="Loading" className='w-full md:w-auto' />
                </div>
            ...
            <div className='text-lg md:text-2xl border rounded border-[rgb(167,163,163)] w-full md:w-6/12 py-6 md:py-10 my-6 md:my-10'>
                <div className='border rounded border-[rgb(167,163,163)] my-4 md:my-6 mx-2 md:mx-4'>
